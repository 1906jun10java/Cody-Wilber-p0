...
AS
BEGIN
    INSERT INTO CUSTOMER VALUES(CUSTOMER_SEQUENCE.NEXTVAL, FIRST_NAME, LAST_NAME, USERNAME, PASS);
    COMMIT;
END;
/
...
AS
BEGIN
    INSERT INTO EMPLOYEE VALUES(EMPLOYEE_SEQUENCE.NEXTVAL, FIRST_NAME, LAST_NAME, USERNAME, PASS);
    COMMIT;
END;
/
